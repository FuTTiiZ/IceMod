...
// Setup sounds..
//
$(document).on( "mouseenter", ".main-menu-option",			function () { lua.PlaySound( "garrysmod/ui_hover.wav" ); } );
$(document).on( "click", ".main-menu-option",				function () { lua.PlaySound( "garrysmod/ui_click.wav" ); } );
